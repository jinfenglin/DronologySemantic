defines window asks user delete
route
FR Delete Route Confirmation Window
serial Version UID
...
route Tobe Deleted
System println ERROR deleting route route
init Message delete route route Tobe Deleted
deleted route showing window
external Event
Component Component external Event Component
find Ancestor FR Info Box
main Layout Route find Ancestor FR Info Box
Click listeners buttons window
add Button Click Listener
close
delete route deleted set
delete Route route Tobe Deleted
route Tobe Deleted
equals main Layout Controls Info Panel Highlighted FR Info Box
main Layout Map Component Edit Mode Controller exit Edit Mode
main Layout Map Component display Route
main Layout Controls Info Panel refresh Routes
Refreshes routes immediately window clicked
main Layout Controls Info Panel refresh Routes
add Button Click Listener
close
show Window
Deletes route Dronology based Flight Route Info
