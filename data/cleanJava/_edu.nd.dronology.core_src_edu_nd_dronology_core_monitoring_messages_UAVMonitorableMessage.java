...
type type
uavid uavid
Artifact Identifier Artifact Identifier ROOT INTERNAL type uavid
data
data GSON Json data
datatype data Simple
Message Type Type
type
Precise Timestamp Timestamp
timestamp
...
Data Type
datatype
Format Util format Timestamp timestamp Message type uav uavid data