...
drone
Normal behavior
GROUND AWAITING TAKEOFF CLEARANCE TAKING
FLYING
AIR LANDING
...
Provider Drone Flight State Manager
Flight Mode
GROUND AWAITING TAKEOFF CLEARANCE TAKING
FLYING
AIR LANDING USER CONTROLLED
Flight Mode Transition
GROUND PLAN ASSIGNED TAKEOFF GRANTED TARGET ALTITUED REACHED PLAN COMPLETE
ALTITUED REACHED LANDING GRANTED MANUAL TAKEOFER
State Machine uav State Machine
uavid
listeners
Constructor States
Flight Mode
...
build State Machine
uav State Machine
State Machine Flight Mode
GROUND
uav State Machine configure Flight Mode
GROUND permit Flight Mode Transition PLAN ASSIGNED
...
Flight Mode TAKING
uav State Machine configure Flight Mode TAKING
permit Flight Mode Transition TARGET ALTITUED REACHED
Flight Mode FLYING
uav State Machine configure Flight Mode FLYING permit Flight Mode Transition PLAN COMPLETE Flight Mode
AIR
uav State Machine configure Flight Mode
AIR permit Flight Mode Transition PLAN ASSIGNED Flight Mode FLYING
uav State Machine configure Flight Mode
AIR permit Flight Mode Transition LANDING GRANTED Flight Mode LANDING
uav State Machine configure Flight Mode LANDING permit Flight Mode Transition
ALTITUED REACHED
Flight Mode
GROUND
uav State Machine configure Flight Mode
GROUND permit Flight Mode Transition MANUAL TAKEOFER
...
Flight Mode USER CONTROLLED
uav State Machine configure Flight Mode TAKING
permit Flight Mode Transition MANUAL TAKEOFER
Flight Mode USER CONTROLLED
uav State Machine configure Flight Mode FLYING permit Flight Mode Transition MANUAL TAKEOFER
Flight Mode USER CONTROLLED
uav State Machine configure Flight Mode
AIR permit Flight Mode Transition MANUAL TAKEOFER
Flight Mode USER CONTROLLED
...
mode change
follow allowed state transition
Mode Ground
Flight Zone Exception
Flight Mode State uav State Machine State
uav State Machine Fire Flight Mode Transition
ALTITUED REACHED
uav State Machine fire Flight Mode Transition
ALTITUED REACHED
...
Flight Zone Exception
transition
Flight Mode LANDING directly
uav State Machine State
drone
ground
Ground
uav State Machine State Flight Mode
GROUND
drone
Awaiting Clearance mode
Awaiting Takeoff Clearance
